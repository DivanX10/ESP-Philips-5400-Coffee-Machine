...
namespace esphome
{
    namespace philips_series_5400
    {
        ...
        public:
            ...
            void set_start_button(PhilipsSeries5400Button *key){ // кнопка запуска приготовления кофе
               ...
               start_button->add_on_press_callback([this](void){
                  ...
                  coffee_start(); //запускаем кофе
               });
            }
            void set_test_button(PhilipsSeries5400Button *key){ // кнопка построение рецепта
               test_button = key;
               test_button->add_on_press_callback([this](void){
                  coffee_build(_product, _grind, _cups, _volume, _milk);
               });
            }
            ...
            void coffee_start(); // запуск приготовления кофе из буфера
        ...
        private:
            ...
            PhilipsSeries5400Button *test_button{nullptr}; // кнопка "test"
